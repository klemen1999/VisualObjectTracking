...
dataset_path = '../workspace-dir/sequences' # TODO: set to the dataet path on your disk
...
init_frame = 0
n_failures = 0
tracker_class = load_tracker("../workspace-dir", "particle_tracker")
...
while frame_idx < sequence.length():
    ...
    if debug:
        particles, weights = tracker.get_current_particles()
        sequence.draw_particles(img, particles, weights)
