...
def evaluate_tracker(dataset_path, network_path, results_dir, visualize):
    ...
    for sequence_name in sequences:
        ...
        for i in tqdm(range(1, sequence.length())):
    ...
    redetects_all = tracker.redetects_all
    print("REDETECTS", redetects_all)
    print(f"Average frames needed for redetection: {np.mean(redetects_all)}")
